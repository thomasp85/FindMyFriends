...
cdhitestC <- function(opts, name) {
    .Call('FindMyFriends_cdhitestC', PACKAGE = 'FindMyFriends', opts, name)
}

cdhitC <- function(opts, name) {
    .Call('FindMyFriends_cdhitC', PACKAGE = 'FindMyFriends', opts, name)
}
...
widthSim <- function(groups, width, threshold, progName) {
    .Call('FindMyFriends_widthSim', PACKAGE = 'FindMyFriends', groups, width, threshold, progName)
}
