...
events, frameshifts, problem with the gene grouping (god forbid) or general
...
these, save for gpcGrouping, are embarrassingly parallel and thus easy to
distribute evenly. gpcGrouping on the other hand is recursive and based on an
uneven tree. At the moment the paralellization works by cutting the tree into
subtrees and distributing these trees to the different workers. It is difficult
though to ensure an even distribution of computational load and workers will
often sit idle while waiting for others to finish. A better implementation will
maybe be investigated in the future.
